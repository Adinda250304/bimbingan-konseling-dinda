...
@section('content')
    ...
    <section class="py-24 pt-36 bg-white overflow-hidden min-h-[80vh] flex items-center">
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div class="lg:col-span-6 relative flex justify-center bk-sahabat-img">
                <div class="relative max-w-md w-full">
                    <img src="{{ asset('img/group_counseling.png') }}" alt="BK Sahabat Siswa" class="rounded-[2rem] border border-outline-variant/30 shadow-xl w-full object-cover">
                </div>
            </div>
            
            <!-- Right: Text Content & Empathy Points -->
            <div class="lg:col-span-6 bk-sahabat-text flex flex-col items-start">
                ...
                <h2 class="font-headline-lg text-3xl sm:text-4xl font-extrabold text-on-background mt-4 leading-tight text-left">
                    Tempat Nyaman Berbagi Cerita &amp; Solusi
                </h2>
                <p class="text-body-md text-on-surface-variant mt-4 leading-relaxed font-medium text-left">
